...
public interface ReviewRepository extends JpaRepository<ReviewEntity, Long> {
    ...
    "SELECT new com.example.com.venom.dto.establishment.RatingStats(AVG(r.rating), COUNT(r.id)) " +
    ...
    RatingStats getAverageRatingAndCountByEstablishmentId(@Param("establishmentId") Long establishmentId);
}