...
public class BookingController {
    ...
    public ResponseEntity<BookingEntity> createBooking(@RequestBody BookingCreationDto dto) {
        log.info("--- [POST /api/v1/bookings] Attempting to create booking for establishmentId: {} at time: {}", 
        ...
        log.info("--- [POST /api/v1/bookings] Successfully created booking ID: {}", createdBooking.getId());
